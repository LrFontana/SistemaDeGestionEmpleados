...
namespace LibreriaServer.Helpers
{
    ...
    {
        // Propiedades.
        private readonly ClaimsPrincipal anonimo = new(new ClaimsIdentity()); // reclamo anonimo.
        ...
        // Reclamo principal.
        public static ClaimsPrincipal EstablecerNotificacionPrincipal(NotificacionesPersonalizadaUsuario reclamos)
        {
            if (reclamos.Email is null) return new ClaimsPrincipal();
            return new ClaimsPrincipal(new ClaimsIdentity( 
                new List<Claim>
                {
                    new (ClaimTypes.NameIdentifier, reclamos.Id!),
                    new (ClaimTypes.Name, reclamos.Nombre!),
                    new (ClaimTypes.Email, reclamos.Email!),
                    new (ClaimTypes.Role, reclamos.Rol!),                    
                },"JwtAuth"));
        }
